...
char UNAME [16] = "admin";
char PASSWD [16] = "Password123";

//	char readChar(void)
//	{
//	  char c;
//		while((UART0->FR & (1<<4)) != 0);  //wait for rx to receive something
//		c = UART0->DR;
//		return c;
//	}
//	
...
//	{
//	  while((UART0->FR & (1<<5)) != 0);  //ensure previous transmit has finished
//		UART0->DR = c;
//	}
...
main(void)
    ...
    ConfigureUART();
		...
		{
		  UARTprintf("Welcome to the Tiva C Sensor Station!");
		}
